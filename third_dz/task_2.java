...
public class task_2 {
    ...
    static void sort(List<Integer> list) { // сортируем список для дальнейших операций
        Collections.sort(list);
    }

    static List<Integer> createList(int capacity) { // заполняем список рандомными числами
